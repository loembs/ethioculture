...
export const WorkingDishScroller: React.FC = () => {
  return (
      ...
      <div className="relative h-80 overflow-hidden">
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="flex animate-marquee">
            {/* Premier set de plats */}
            {dishes.map((dish, index) => (
              <div key={`dish1-${dish.id}-${index}`} className="flex-shrink-0 mx-6">
            ...
            {/* Deuxième set de plats pour continuité */}
            {dishes.map((dish, index) => (
              <div key={`dish2-${dish.id}-${index}`} className="flex-shrink-0 mx-6">
                <div className="group relative w-72 h-64 bg-white rounded-2xl shadow-xl overflow-hidden transform hover:scale-105 transition-all duration-300">
                  <div className="relative h-40 overflow-hidden">
                    <img
                      src={dish.image}
